...
import static net.runelite.client.plugins.externals.presetmanager.PresetConverter.PRESET_TO_ITEM_IDS;
...
public class PresetRenderEngine {
                                    ...
                                    Client client)
    {
        ...
        List<Integer> itemIds = PRESET_TO_ITEM_IDS.apply(preset).stream().distinct().collect(Collectors.toList());
