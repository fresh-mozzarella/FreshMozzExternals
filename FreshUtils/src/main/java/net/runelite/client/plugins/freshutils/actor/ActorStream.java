package net.runelite.client.plugins.freshutils.actor;

import net.runelite.client.plugins.freshutils.game.iActor;
import net.runelite.client.plugins.freshutils.scene.LocatableStream;
