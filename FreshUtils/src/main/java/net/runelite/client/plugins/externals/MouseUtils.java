...
public class MouseUtils {
    ...
    public void delayClickRandomPointCenter(int min, int max, int delay) {
    ...
    public void delayMouseClick(Point point, int delay) {
        executorService.submit(() ->
        {
            try {
                sleep(delay);
    ...
    public void delayMouseClick(Rectangle rectangle, int delay) {
        Point point = getClickPoint(rectangle);
