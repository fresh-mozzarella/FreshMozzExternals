...
import net.runelite.client.plugins.freshutils.api.Interactable;
...
public class EquipmentItem implements Interactable {
    ...
    public EquipmentItem(GameAPI game, Item item, ItemComposition definition, EquipmentSlot equipmentSlot) {
        this.game = game;
        this.item = item;
