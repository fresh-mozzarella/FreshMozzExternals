...
import net.runelite.client.plugins.freshutils.walking.TeleportLoader;
...
import static net.runelite.client.plugins.freshutils.walking.TeleportSpell.*;
import static net.runelite.client.plugins.freshutils.walking.TeleportTab.*;
