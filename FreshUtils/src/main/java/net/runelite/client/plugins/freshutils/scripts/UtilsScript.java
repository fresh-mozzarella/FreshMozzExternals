package net.runelite.client.plugins.freshutils.scripts;
...
import net.runelite.client.plugins.freshutils.api.*;
import net.runelite.client.plugins.freshutils.game.*;
import net.runelite.client.plugins.freshutils.scene.RectangularArea;
import net.runelite.client.plugins.freshutils.ui.*;
import net.runelite.client.plugins.freshutils.walking.BankLocations;
import net.runelite.client.plugins.freshutils.walking.Walking;
import net.runelite.client.plugins.freshutils.scene.Area;
import net.runelite.client.plugins.freshutils.util.Util;
