...
import net.runelite.client.plugins.freshutils.game.ItemQuantity;
...
import net.runelite.client.plugins.freshutils.walking.TeleportSpell;
import net.runelite.client.plugins.freshutils.walking.TeleportTab;
...
public class TeleportMethod {
    ...
    public TeleportMethod(GameAPI game, TeleportLocation teleportLocation, int quantity) {
