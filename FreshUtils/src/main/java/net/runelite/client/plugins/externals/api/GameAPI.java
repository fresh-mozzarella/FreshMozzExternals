...
import net.runelite.client.plugins.externals.FreshConfig;
import net.runelite.client.plugins.externals.FreshUtils;
import net.runelite.client.plugins.externals.KeyboardUtils;
import net.runelite.client.plugins.externals.Pathfinding.WalkUtils;
import net.runelite.client.plugins.externals.streams.*;
...
import static net.runelite.client.plugins.externals.FreshUtils.sleep;
...
public class GameAPI {
    ...
    public FreshConfig config() { return utils.config; }
