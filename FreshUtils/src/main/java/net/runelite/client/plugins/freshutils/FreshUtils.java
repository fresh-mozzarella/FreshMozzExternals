...
import net.runelite.client.plugins.freshutils.game.iObject;
import net.runelite.client.plugins.freshutils.game.iWidget;
...
public class FreshUtils extends Plugin {
    ...
    @Provides
    FreshConfig provideConfig(ConfigManager configManager) {
        return configManager.getConfig(FreshConfig.class);
    }
