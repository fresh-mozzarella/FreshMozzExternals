...
import net.runelite.client.plugins.freshutils.*;
import net.runelite.client.plugins.freshutils.actor.NpcStream;
import net.runelite.client.plugins.freshutils.actor.PlayerStream;
import net.runelite.client.plugins.freshutils.api.EquipmentSlot;
import net.runelite.client.plugins.freshutils.scene.GameObjectStream;
import net.runelite.client.plugins.freshutils.scene.GroundItemStream;
import net.runelite.client.plugins.freshutils.scene.ObjectCategory;
import net.runelite.client.plugins.freshutils.scene.Position;
import net.runelite.client.plugins.freshutils.ui.EquipmentItemStream;
import net.runelite.client.plugins.freshutils.ui.InventoryItemStream;
import net.runelite.client.plugins.freshutils.util.LegacyInventoryAssistant;
...
import static net.runelite.client.plugins.freshutils.FreshUtils.sleep;
...
public class GameAPI {
    ...
    public GameObjectStream objects() {
        return getFromClientThread(() -> new GameObjectStream(FreshUtils.objects.stream()
                .map(o -> new iObject(
                        this,
                        o,
    ...
    public GroundItemStream groundItems() {
        return getFromClientThread(() -> new GroundItemStream(FreshUtils.tileItems.stream()
